# cloud-itonami-lei-2549005o5pva2jch6q33

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by ComfortDelGro Corporation Limited.**

This repository archives the publicly published Terms of Use of **ComfortDelGro
Corporation Limited**, with source-url and retrieval-date provenance, per
...
- **Legal name**: ComfortDelGro Corporation Limited
- **LEI (ISO 17442)**: [2549005O5PVA2JCH6Q33](https://search.gleif.org/#/record/2549005O5PVA2JCH6Q33) (GLEIF-verified; entity status ACTIVE; LEI **registration status LAPSED** — recorded honestly, not glossed over)
...
ComfortDelGro is one of the world's largest land-transport operators, running
urban public bus networks (and taxi/point-to-point mobility) across Singapore,
the UK, Australia, China and elsewhere. This vertical's *generic, forkable* Open
